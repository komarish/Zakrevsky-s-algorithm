...
int greedHeuristics::findMinRangRowIndex(NodeBoolTree*& node, int sz, int countVar)
{
...
Component greedHeuristics::checkRules(NodeBoolTree*& node, int sz, int countVar)
{
...
Component simpleHeuristics::checkRules(NodeBoolTree*& node, int sz, int countVar)
{
